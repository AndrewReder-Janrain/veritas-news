...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://veritasnewscorp-demo.rpxnow.com";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "cpflbohghdahdfbimcmf";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://veritasnewscorp-demo.rpxnow.com";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook","twitter"];
if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "646425022166252";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://veritasnewscorp-demo.rpxnow.com";
...
if (typeof janrain.settings.share.providers === 'undefined')janrain.settings.share.providers = ["native-facebook","native-twitter"];
